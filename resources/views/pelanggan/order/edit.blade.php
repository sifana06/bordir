...
<div class="row">
    ...
    @endif
    <form action="{{route('po.updateOrder',$order->id)}}" method="post" enctype="multipart/form-data">
        {{ csrf_field() }}
        {{ method_field('PUT') }}
        <div class="col-md-7">
            <div class="box box-info">
                <div class="box-header with-border" style="margin-left:0px;">
                    ...
                    <div class="box-body">
                            <input type="text" name="pemilik_id" value="{{$order->pemilik_id}}" hidden="true">
                            <input type="text" name="store_id" value="{{$order->store_id}}" hidden="true">
                            <input type="text" name="user_id" value="{{$order->user_id}}" hidden="true">
                            <input type="text" name="product_id" value="{{$order->product_id}}" hidden="true">
                            <input type="text" name="order_number" value="{{$order->order_number}}" hidden="true">
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group" style="margin-top:5px;margin-bottom:0px;">
                                    ...
                                    <input type="text" class="form-control" name="nama_pelanggan"  value="{{$order->nama_pelanggan}}" readonly=>
                                </div>
                                <div class="form-group" style="margin-top:0px;">
                ...
                <div class="box box-info">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group" style="margin-top:0px;margin-bottom:0px;" id="rekeningFieldDiv">
                            ...
                            <select name="rekening_id" id="rekeningField" class="form-control col-sm-12" required="">
                        ...
                        <div class="form-group" style="margin-top:0px;margin-bottom:0px;" id="tglFieldDiv">
                            ...
                            <input type="date" name="tanggal_pembayaran" id="tglField" class="form-control" value="{{$order->tanggal_pembayaran}}">
                        </div>
