...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="box box-primary">
            <div class="box-header with-border">
                <div class="box-title">
                    <h4 style="margin-top: 0px; margin-bottom: 0px;"><a href="{{route('rekening.index')}}"><span
                                class="fa fa-arrow-left"></span></a> Tambah Nomor Rekaning Baru</h4>
                </div>
            </div>
            <!-- /.box-header -->
            @if($errors->any())
            ...
            @endif
            <!-- form start -->
            <form method="post" action="{{ route('rekening.store')}}" enctype="multipart/form-data" autocomplete="off" onsubmit="return validateOnSubmit();">
                <div class="box-body">
                    @csrf
